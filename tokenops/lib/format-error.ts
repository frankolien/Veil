...
const FRIENDLY_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/not registered/i, "Wallet pair not registered for this token yet. Run Step 1 first."],
  [/not operator/i, "Operator approval missing for this token."],
  [/insufficient balance/i, "Your confidential balance is too low for this disperse."],
];
